...
class AgendaManager:
        ...
        if os.path.exists(self.config_file):
            try:
                with open(self.config_file, 'r', encoding='utf-8') as f:
                    ...
                    print(f"✅ Configuración de agenda cargada: {len(self.proveedores)} proveedores")
            except Exception as e:
                print(f"⚠️ Error cargando configuración de agenda: {e}")
                self._crear_configuracion_default()
        else:
            print("📝 Creando configuración de agenda por defecto...")
            self._crear_configuracion_default()
    ...
    def guardar_configuracion(self):
        ...
        try:
            ...
            print(f"✅ Configuración de agenda guardada")
        except Exception as e:
        ...
        for idx, row in df.iterrows():
            ...
            if codigo_prov:
                ...
                if fecha_entrega:
                    ...
                    print(f"⚠️ Proveedor {codigo_prov} no configurado en agenda")
